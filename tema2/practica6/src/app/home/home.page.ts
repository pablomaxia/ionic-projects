...
export class HomePage {
  ...
  ciudades= ["sevilla", "madrid", "barcelona", "zaragoza"];
  categorias= ["analista", "programador_senior", "programador_junior"];
  empleados= [
      {
        "apellidos": "Dundridge",
        "nombre": "Bud",
  ...
  buscar(){
    ...
    for (let i = 0; i < this.empleados.length; i++) {
      if (
        this.empleados[i].categoria == this.cat &&
        this.empleados[i].sueldo >= this.sueldo &&
        this.empleados[i].practicas == this.practicas &&
        this.empleados[i].ciudad == this.ciudad){
        this.empleadosMostrar[i] = this.empleados[i];
      }
