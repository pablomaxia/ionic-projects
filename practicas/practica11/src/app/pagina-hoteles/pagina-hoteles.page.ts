...
@Component({
  selector: 'app-pagina-hoteles',
  templateUrl: './pagina-hoteles.page.html',
  styleUrls: ['./pagina-hoteles.page.scss'],
})
export class PaginaHotelesPage implements OnInit {
  ...
  datosHotel(hotel: Hotel) {
    console.log(hotel);
    //routerLink="/pagina-hoteles" routerDirection="forward"
